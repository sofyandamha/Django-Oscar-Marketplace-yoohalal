...
class NewAbstractAddress(models.Model):
    """
    ...
    line4 = models.CharField(_("Fourth line of address"), max_length=255, blank=True)

    # New address fields
    full_address = models.TextField(_('Full address'), blank=True)
    sub_districts = models.CharField(_("Sub-districts"), max_length=255, blank=True)
    ...
    def save(self, *args, **kwargs):
        ...
        super(NewAbstractAddress, self).save(*args, **kwargs)

    def clean(self):
        # Strip all whitespace
        for field in ['full_name', 'full_address', 'sub_districts', 'city',
                      'first_name', 'last_name', 'line1', 'line2', 'line3',
    ...
    def _update_search_text(self):
        search_fields = filter(
            bool, [self.full_name, self.first_name, self.last_name,
                   self.line1, self.line2, self.line3, self.line4,
                   self.full_address, self.sub_districts, self.city,
    ...
    def active_address_fields(self, include_salutation=True):
        ...
        # change include field on address info
        fields = [self.full_address, self.sub_districts, self.city, self.state, self.postcode]
...
class NewAbstractShippingAddress(NewAbstractAddress):
    """
    A shipping address.
    ...
    notes = models.TextField(
        blank=True, verbose_name=_('Note'),
...
class NewAbstractUserAddress(NewAbstractShippingAddress):
    """
    ...
    def save(self, *args, **kwargs):
        ...
        super(NewAbstractUserAddress, self).save(*args, **kwargs)
    ...
    def validate_unique(self, exclude=None):
        super(NewAbstractAddress, self).validate_unique(exclude)
...
class NewAbstractBillingAddress(NewAbstractAddress):
    class Meta:
        abstract = True
